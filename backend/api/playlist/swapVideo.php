<?php
/**
 * This script is used for swapping videos in a playlist in the system.
...
if (isset($json->pos1)
    && isset($json->pos2)                               // If correct variables is given.
    && isset($json->pid)) {
    ...
    if (isset($_SESSION['uid'])) {                              // Check if logged in.
        ...
        if ($isMaintainer) {                                                             // Check if maintainer.
            ...
            $result = $playlistManager->swapPositionsInPlaylist(                            // swap video position.
                htmlspecialchars($json->pos1),
                htmlspecialchars($json->pos2),
